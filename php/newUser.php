<?php
/**
 * Funkce vytváří novou uživatelskou stránku pro nově zaregistrovaného uživatele.
 *
 * @param $nameUser
 * Uzivatelske jmeno (funguje jako id)
 *
 * Vytvari pro noveho uzivatele jeho vlastni uzivatelskou stranku
 */
function createUserPage($nameUser){
    $html = '<?php
...
<head>
    <meta charset="UTF-8">
    <title>'.htmlspecialchars($nameUser).'</title>
...
<header class="header">
    ...
    <a href="'.$nameUser.'.php"><div class="userPage"><p><i class="fas fa-user"></i> <?php echo $loggedUser->username; ?></p></div></a>
...
<main class="container"> 
    ...
    <div class="main">
        <h1 id="h1"><i class="far fa-address-card"></i> '.htmlspecialchars($nameUser).'</h1>
...
//    file_get_contents("databaze/users/$nameUser.php");
    file_put_contents("databaze/users/$nameUser.php", $html);
}
