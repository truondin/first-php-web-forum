...
$answers = createDbAnswer("4998f76fc745f24b");
...
if(isset($_POST["send"])){
    ...
    $emptyInput = addAnswer("4998f76fc745f24b", $answer,$loggedUser->username);
    header("location:4998f76fc745f24b.php");
    }
}
...
if (isset($_POST["delete"])){
    foreach ($answers as $delAns){
        if ($delAns->id === $_POST["id"]){
            deleteAnswer($delAns, "4998f76fc745f24b");
            header("location:4998f76fc745f24b.php");
        }
    }
}
...
<main class="container"> 
    ...
    <div class="main">
        <?php
        echoDiscussion($diskuze,"4998f76fc745f24b");
        ?>
        ...
        <h3>
            ...
            changePage($page, $numOfAnswers,"4998f76fc745f24b" );
            }
            ?>
        </h3>
