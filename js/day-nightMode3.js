...
function dark(){
    ...
    document.querySelector(".headline").classList.add("nightInput");
    document.querySelector(".question").classList.add("nightInput");
...
function light(){
    ...
    document.querySelector(".headline").classList.remove("nightInput");
    document.querySelector(".question").classList.remove("nightInput");
}
